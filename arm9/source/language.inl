...
STRING(EXECUTE_LUA_SCRIPT, "Execute Lua script")
...
STRING(SELECT_LUA_SCRIPT, "Select Lua script...")
...
STRING(LUA_SCRIPTS, "Lua scripts...")
...
STRING(LUA_SCRIPTS_DIRECTORY_NOT_FOUND, "Lua scripts directory not found.\n(default path: 0:/gm9/%s)")
STRING(HOME_LANGUAGE_MENU_SELECT_LANGUAGE, "HOME language... menu.\nSelect language:")
STRING(HOME_SCRIPTS_MENU_SELECT_SCRIPT, "HOME scripts... menu.\nSelect script:")
STRING(HOME_LUA_SCRIPTS_MENU_SELECT_SCRIPT, "HOME Lua scripts... menu.\nSelect script:")
...
STRING(LUA_NOT_INCLUDED, "This build of GodMode9 was\ncompiled without Lua support.")
