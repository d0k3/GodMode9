...
static const VirtualNandTemplate vNandTemplates[] = {
    ...
    { "twln.img"         , NP_TYPE_FAT   , NP_SUBTYPE_TWL  , 0, 0 },
    { "twlp.img"         , NP_TYPE_FAT   , NP_SUBTYPE_TWL  , 1, 0 },
    ...
    { "ctrnand_fat.img"  , NP_TYPE_FAT   , NP_SUBTYPE_CTR  , 0, 0 },
    { "ctrnand_fat.img"  , NP_TYPE_FAT   , NP_SUBTYPE_CTR_N, 0, 0 },
    { "bonus.img"        , NP_TYPE_BONUS , NP_SUBTYPE_CTR  , 0, VFLAG_DELETABLE },
