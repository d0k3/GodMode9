...
static const VirtualNandTemplate vNandTemplates[] = {
    ...
    { "twln.fat16.img"         , NP_TYPE_FAT   , NP_SUBTYPE_TWL  , 0, 0 },
    { "twlp.fat12.img"         , NP_TYPE_FAT   , NP_SUBTYPE_TWL  , 1, 0 },
    { "agbsave.bin"      , NP_TYPE_AGB   , NP_SUBTYPE_CTR  , 0, VFLAG_DELETABLE },
    { "firm0.firm"        , NP_TYPE_FIRM  , NP_SUBTYPE_CTR  , 0, 0 },
    { "firm1.firm"        , NP_TYPE_FIRM  , NP_SUBTYPE_CTR  , 1, 0 },
    { "firm2.firm"        , NP_TYPE_FIRM  , NP_SUBTYPE_CTR  , 2, 0 },
    { "firm3.firm"        , NP_TYPE_FIRM  , NP_SUBTYPE_CTR  , 3, 0 },
    { "firm4.firm"        , NP_TYPE_FIRM  , NP_SUBTYPE_CTR  , 4, 0 },
    { "firm5.firm"        , NP_TYPE_FIRM  , NP_SUBTYPE_CTR  , 5, 0 },
    { "firm6.firm"        , NP_TYPE_FIRM  , NP_SUBTYPE_CTR  , 6, 0 },
    { "firm7.firm"        , NP_TYPE_FIRM  , NP_SUBTYPE_CTR  , 7, 0 },
    { "ctrnand_full.bin" , NP_TYPE_STD   , NP_SUBTYPE_CTR  , 0, 0 },
    { "ctrnand_full.bin" , NP_TYPE_STD   , NP_SUBTYPE_CTR_N, 0, 0 },
    { "ctrnand_fs.fat16.img"  , NP_TYPE_FAT   , NP_SUBTYPE_CTR  , 0, 0 },
    { "ctrnand_fs.fat16.img"  , NP_TYPE_FAT   , NP_SUBTYPE_CTR_N, 0, 0 },
    { "bonus.fat16.img"        , NP_TYPE_BONUS , NP_SUBTYPE_CTR  , 0, VFLAG_DELETABLE },
