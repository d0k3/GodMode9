...
#define GAME_INJECT (1UL<<5)
#define GAME_TMD    (1UL<<6)
#define GAME_EXEFS  (1UL<<7)
#define GAME_ROMFS  (1UL<<8)
#define GAME_BOSS   (1UL<<9)
#define GAME_NUSCDN (1UL<<10)
#define GAME_TICKET (1UL<<11)
#define GAME_SMDH   (1UL<<12)
#define GAME_NDS    (1UL<<13)
#define SYS_FIRM    (1UL<<14)
#define SYS_TICKDB  (1UL<<15)
#define BIN_NCCHNFO (1UL<<16)
#define BIN_LAUNCH  (1UL<<17)
#define BIN_TIKDB   (1UL<<18)
#define BIN_KEYDB   (1UL<<19)
#define BIN_LEGKEY  (1UL<<20)
#define BIN_SUPPORT (1UL<<21)
